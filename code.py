...
root = Tk()
root.title("Inventory System By Harsh")
...
def insert_data():
    ...
    my_tree.tag_configure('orow', background='#F7F7F7')
...
titleLabel = Label(root, text=storeName, font=('Arial bold', 30), bd=2, bg='#D3D3D3', fg='#333333')
titleLabel.grid(row=0, column=0, columnspan=8, padx=20, pady=20)

idLabel = Label(root, text="ID", font=('Arial bold', 15), bg='#D3D3D3', fg='#333333')
nameLabel = Label(root, text="Name", font=('Arial bold', 15), bg='#D3D3D3', fg='#333333')
priceLabel = Label(root, text="Price", font=('Arial bold', 15), bg='#D3D3D3', fg='#333333')
quantityLabel = Label(root, text="Quantity", font=('Arial bold', 15), bg='#D3D3D3', fg='#333333')
...
buttonEnter = Button(
    ...
    bd=3, font=('Arial', 15), bg="#00cc66", fg='white', command=insert_data)
buttonEnter.grid(row=5, column=1, columnspan=1)

buttonUpdate = Button(
    root, text="Update", padx=5, pady=5, width=5,
    bd=3, font=('Arial', 15), bg="#ff9900", fg='white', command=update_data)
buttonUpdate.grid(row=5, column=2, columnspan=1)

buttonDelete = Button(
    root, text="Delete", padx=5, pady=5, width=5,
    bd=3, font=('Arial', 15), bg="#ff3333", fg='white', command=delete_data)
buttonDelete.grid(row=5, column=3, columnspan=1)

style = ttk.Style()
style.configure("Treeview.Heading", font=('Arial bold', 15), background='#0099ff', foreground='white')
